...
//  Bullseye
//
//  Created by malakoipechyva on 2/5/20.
...
struct AboutView: View {
    ...
    var body: some View {
        ...
        VStack {
            ...
            Text("Your goal is to place the slider as close is possible to the target value. The closer you are, the more point of your score.").modifier(AboutBodyStyle()).lineLimit(nil)
